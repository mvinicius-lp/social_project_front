<template>
  <div class= "layout">
    <Sidebar :active="'doacoes'" @navigate="onNavigate"  @logout="handleLogout" />
...
import NewDonationModal from '../components/NewDonationsModal.vue'; // Caminho relativo para componentes
...
.donations-page-content {
  flex: 1;
  padding: 20px;
  background-color: #f9fafb; /* Cinza claro para o fundo */
}
